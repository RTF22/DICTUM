...
_FILLER_WORDS = [
    r"\bäh+m?\b", r"\bähm+\b", r"\bhm+\b", r"\bumm?\b",
    r"\bnaja\b", r"\btja\b", r"\bhalt\b", r"\bhalt\s+so\b",
    r"\bsozusagen\b", r"\bquasi\b", r"\birgendwie\b",
    r"\bsag\s+ich\s+mal\b", r"\bsagen\s+wir\s+mal\b",
    r"\bim\s+Prinzip\b", r"\bim\s+Grunde\s+genommen\b",
    r"\bgrundsätzlich\b", r"\beigentlich\b",
    r"\bja\s+also\b", r"\balso\b",
